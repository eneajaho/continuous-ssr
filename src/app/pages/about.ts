  ...
  template: `
    <article class="max-w-2xl space-y-6">
      ...
      <ul class="list-disc space-y-2 pl-5 text-zinc-800 dark:text-zinc-200">
        ...
        <li><strong>About</strong>: this banner is route-local server state through <code class="text-sm">transferredState</code>; changing it re-renders this page alone.</li>
      </ul>
